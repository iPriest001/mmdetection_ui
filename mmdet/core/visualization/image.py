...
def imshow_det_bboxes(img,
    ...
    polygons = []
    color = []
    ui_result = []  # add for ui show information
    for i, (bbox, label) in enumerate(zip(bboxes, labels)):
        ...
        if ui_show == True:  # add for ui show information
            ui_result.append([class_names[label], bbox[-1], bbox[0], bbox[1], bbox[2], bbox[3]])
